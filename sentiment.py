...
class ChatbotApp:
    ...
    def generate_explanation(self, sentiment, polarity, subjectivity):
        ...
        explanation += (
            f"It generally expresses a {'positive' if sentiment == 'Positive' else 'negative' if sentiment == 'Negative' else 'neutral'}"
            f"The polarity score is {polarity:.2f}, where a higher value indicates a more positive sentiment, and a lower value indicates a more negative sentiment."
            f"The subjectivity score is {subjectivity:.2f}, where a higher value indicates a more subjective statement."
        )
        return explanation
